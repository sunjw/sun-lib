...
namespace sunjwbase
{
	...
	// converting part
	std::string strtoutf8(const std::string& charset, const std::string& str);
	inline std::string strgbktoutf8(const std::string& str)
	{ return strtoutf8(std::string("GBK"), str); }
	std::string strutf8tougbk(const std::string& str);
